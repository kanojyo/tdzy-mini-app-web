        ...
        <div class="table">
            <div class="table-list">
                <el-table :data="list" border height="750" :header-cell-style="{background:'#f3f3f3'}">
                    ...
                    <el-table-column align="center" prop="name" label="医生名称"></el-table-column>
...
import { doctorIndex, doctorSave, doctorUpdate, doctorInfo, doctorStatus } from "@/api/doctor.js";
